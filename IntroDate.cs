...
namespace SuperNewRoles.Modules
{
    ...
    public class IntroDate
    {
        ...
        public static IntroDate MadStuntManIntro = new("MadStuntMan", RoleClass.MadStuntMan.color, 1, RoleId.MadStuntMan);
        ...
        public static IntroDate TeleportingJackalIntro = new("TeleportingJackal", RoleClass.TeleportingJackal.color, 3, RoleId.TeleportingJackal, TeamRoleType.Neutral);
