...
[The Other Roles GM Haoming](https://github.com/haoming37/TheOtherRoles-GM-Haoming) - ベント追加のコードを参考にさせていただきました！**Haoming**さんありがとうございます！<br>
...
| 名前 | 説明 |
|----------|:-------------:|
| ヴァンパイアのキルクールタイム | ヴァンパイアのキルクールタイムを設定できます。
...
| 名前 | 説明 |
|----------|:-------------:|
| 侍のキルクールタイム | ヴァンパイアのキルクールタイムを設定できます。
...
キルとベントができます。<br>
サイドキックボタンを押すと、<br>
ターゲットを[サイドキック(シーア)](#サイドキック(シーア))にできます。<br>
サボタージュができるかは設定で変更可能。<br>
...
死亡後役職が変化し、
TORGMのエンジニアのリペアの様に、サボタージュを治せるようになる。<br>

### ゲーム設定
| 名前 | 説明 |
|----------|:-------------:|
| サボタージュ修復可能回数 | サボタージュが修復できる最大回数を設定できます。
