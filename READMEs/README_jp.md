...
#### Description
一定時間警戒することが出来ます。<br>
警戒中にキルされそうになると、そのキルを防ぎ相手の視界を奪い、一定時間自身の移動速度が上昇します。

#### 能力
- 警戒ボタンを持っており、発動することで警戒することができます。
- 警戒中にキルされるとキルを防ぐことが出来ます。
- 更に相手の視界を一時的に狭め、墨を表示させ、キルレンジを一時的にショートにします。
- そして、一時的に自身の移動速度が上がります。

#### ゲーム設定
| 名前 | 説明 |
| ---- |:----:|
| 警戒モードのクールタイム | 能力のクールタイムを設定できます |
| 警戒モードの持続時間 | 能力の持続時間を設定できます |
| カウンター成功時の移動速度 | 警戒中にキルされた時の移動速度を設定できます |
| カウンター成功時の移動速度が上がる時間 | 警戒中にキルされた時の移動速度の持続時間を設定できます |
| カウンター成功時のキルが出来ない時間 | 警戒中にキルされた時の相手のキルクールを設定できます |
| 視界が奪われたときの視野 | 警戒中にキルされた時の相手の視野を設定できます |
| 視界を奪う時間 | 警戒中にキルされた時の相手の 視野, 墨, キルレンジ変更 の持続時間を設定できます |
---
