    ...
    static class HudManagerStartPatch
    {
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            WaveCannonButton = new(
                ...
                () =>
                {
                    WaveCannonButton.MaxTimer = CachedPlayer.LocalPlayer.PlayerControl.IsRole(RoleId.WaveCannon) ? CustomOptions.WaveCannonCoolTime.GetFloat() : CustomOptions.WaveCannonJackalCoolTime.GetFloat();
                    WaveCannonButton.Timer = WaveCannonButton.MaxTimer;
                    WaveCannonButton.effectCancellable = false;
                    WaveCannonButton.EffectDuration = CachedPlayer.LocalPlayer.PlayerControl.IsRole(RoleId.WaveCannon) ? CustomOptions.WaveCannonChargeTime.GetFloat() : CustomOptions.WaveCannonJackalChargeTime.GetFloat();
