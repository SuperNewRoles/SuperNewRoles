        ...
        public static void Postfix(HudManager __instance)
        {
            PavlovsdogKillButton = new(
                () =>
                {
                    ...
                    ModHelpers.CheckMuderAttemptAndKill(CachedPlayer.LocalPlayer.PlayerControl, target);
            ...
            JackalKillButton = new(
                () =>
                {
                    ...
                    {
                        ModHelpers.CheckMuderAttemptAndKill(CachedPlayer.LocalPlayer.PlayerControl, PlayerControlFixedUpdatePatch.JackalSetTarget());
            ...
            EvilHackerMadmateSetting = new(
                ...
                {
                    var target = SetTarget();
                    if (!target.Data.Role.IsImpostor && target && RoleHelpers.IsAlive(CachedPlayer.LocalPlayer.PlayerControl) && CachedPlayer.LocalPlayer.PlayerControl.CanMove && RoleClass.EvilHacker.IsCreateMadmate)
                    {
                        Madmate.CreateMadmate(target);
...
&& RoleClass.PositionSwapper.SwapCount > 0 && true && CachedPlayer.LocalPlayer.PlayerControl.CanMove;
            ...
            SecretlyKillerMainButton = new(
                () =>
                {
                    ModHelpers.CheckMuderAttemptAndKill(CachedPlayer.LocalPlayer.PlayerControl, RoleClass.SecretlyKiller.target);
...
&& !RoleClass.SecretlyKiller.target.IsImpostor() && CachedPlayer.LocalPlayer.PlayerControl.CanMove;
            ...
            DoubleKillerMainKillButton = new(
                () =>
                {
                    ...
                    {
                        ModHelpers.CheckMuderAttemptAndKill(CachedPlayer.LocalPlayer.PlayerControl, PlayerControlFixedUpdatePatch.SetTarget());
                        switch (CachedPlayer.LocalPlayer.PlayerControl.GetRole())
                        {
            ...
            HitmanKillButton = new(
                ...
                {
                    PlayerControl target = SetTarget();
                    if (ModHelpers.CheckMuderAttemptAndKill(CachedPlayer.LocalPlayer.PlayerControl, target) == ModHelpers.MurderAttemptResult.PerformKill)
                    {
                    }
            ...
            StefinderKillButton = new(
                () =>
                {
                    ...
                    ModHelpers.CheckMuderAttemptAndKill(CachedPlayer.LocalPlayer.PlayerControl, RoleClass.Stefinder.target);
                },
