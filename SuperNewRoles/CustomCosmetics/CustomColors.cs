...
public class CustomColors
{
    ...
    private static readonly Dictionary<ColorType, (Color32, Color32, bool)> CustomColorData = new() {
            ...
            { ColorType.Pitchred, (new(255, 0, 0, bmv), new(178, 0, 0, bmv), true) },
            ...
            { ColorType.Teal, (new(0x25, 0xB8, 0xBF, bmv), new(0x12, 0x89, 0x86, bmv), true) },
            ...
            { ColorType.Pitchblue, (new(0, 0, 255, bmv), new(0, 0, 172, bmv), true) },
            ...
            { ColorType.Sunkengreenishblue, (new(128, 156, 166, bmv), new(115, 141, 153, bmv), false) },
