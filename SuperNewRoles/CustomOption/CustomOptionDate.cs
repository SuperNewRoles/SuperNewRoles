    ...
    public class CustomOptions
    {
        ...
        public static void Load()
        {
            ...
            */
            ...
            DoppelgangerOption = new CustomRoleOption(893, false, CustomOptionType.Impostor, "DoppelgangerName", RoleClass.Doppelganger.color, 1);
            DoppelgangerPlayerCount = CustomOption.Create(894, false, CustomOptionType.Impostor, "SettingPlayerCountName", ImpostorPlayers[0], ImpostorPlayers[1], ImpostorPlayers[2], ImpostorPlayers[3], DoppelgangerOption);
            DoppelgangerDurationTime = CustomOption.Create(895, false, CustomOptionType.Impostor, "DoppelgangerDurationTimeSetting", 90f, 0f, 250f, 5f, DoppelgangerOption);
            DoppelgangerCoolTime = CustomOption.Create(896, false, CustomOptionType.Impostor, "DoppelgangerCoolDownSetting", 5f, 5f, 250f, 2.5f, DoppelgangerOption);
            DoppelgangerSucTime = CustomOption.Create(897, false, CustomOptionType.Impostor, "DoppelgangerSucTimeSetting", 2.5f, 0f, 120f, 2.5f, DoppelgangerOption);
            DoppelgangerNotSucTime = CustomOption.Create(898, false, CustomOptionType.Impostor, "DoppelgangerSucTimeSetting", 50f, 0f, 120f, 2.5f, DoppelgangerOption);
