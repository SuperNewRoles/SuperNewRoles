    ...
    public class CustomOptions
    {
        ...
        public static void Load()
        {
            ...
            */
            ...
            SuicideWisherOption = new CustomRoleOption(656, false, CustomOptionType.Impostor, "SuicideWisherName", RoleClass.Smasher.color, 1);
            SuicideWisherPlayerCount = CustomOption.Create(657, false, CustomOptionType.Impostor, "SettingPlayerCountName", ImpostorPlayers[0], ImpostorPlayers[1], ImpostorPlayers[2], ImpostorPlayers[3], SmasherOption);
            //表示設定
