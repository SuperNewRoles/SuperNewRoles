...
namespace SuperNewRoles.Intro
{
    public class IntroDate
    {
        ...
        public static IntroDate TeleportingJackalIntro = new("TeleportingJackal", RoleClass.TeleportingJackal.color, 1, RoleId.TeleportingJackal, TeamRoleType.Neutral);
        ...
        public static IntroDate SidekickFriendsIntro = new("SidekickFriends", RoleClass.Jackal.color, 1, RoleId.SidekickFriends, TeamRoleType.Crewmate);
