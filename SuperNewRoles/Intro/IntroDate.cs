...
namespace SuperNewRoles.Intro
{
    public class IntroDate
    {
        ...
        public static IntroDate AllCloserIntro = new("AllCloser", RoleClass.AllCloser.color, 1, RoleId.AllCloser, TeamRoleType.Crewmate);
        public static IntroDate MadAllCloserIntro = new("MadAllCloser", RoleClass.MadAllCloser.color, 1, RoleId.MadAllCloser, TeamRoleType.Crewmate);
        //イントロオブジェ
    }
}
