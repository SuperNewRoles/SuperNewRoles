...
namespace SuperNewRoles.Intro
{
    public class IntroDate
    {
        ...
        public static IntroDate ShadowWarriorIntro = new IntroDate("ShadowWarrior", RoleClass.ShadowWarrior.color, 1, CustomRPC.RoleId.ShadowWarrior);
        //イントロオブジェ
    }
}
