...
namespace SuperNewRoles.Map.Agartha.Patch
{
    class MiniMapPatch
    {
        public static void MinimapChange(MapBehaviour __instance)
        {
            ...
            AdminRoom.GetComponent<TextMeshPro>().text = TranslationController.Instance.GetString((RoleTypes)StringNames.Admin);
            ...
            new LateTask(() =>
            SecurityRoom.GetComponent<TextMeshPro>().text = TranslationController.Instance.GetString((RoleTypes)StringNames.Security)
            , 0f, "SetMapText");
            ...
            new LateTask(() =>
            LifeSuppRoom.GetComponent<TextMeshPro>().text = TranslationController.Instance.GetString((RoleTypes)StringNames.LifeSupp)
            , 0f, "SetMapText");
            ...
            new LateTask(() =>
            MeetingRoom.GetComponent<TextMeshPro>().text = TranslationController.Instance.GetString((RoleTypes)StringNames.MeetingRoom)
            , 0f, "SetMapText");
            ...
            new LateTask(() =>
            ElectricalRoom.GetComponent<TextMeshPro>().text = TranslationController.Instance.GetString((RoleTypes)StringNames.Electrical)
            , 0f, "SetMapText");
