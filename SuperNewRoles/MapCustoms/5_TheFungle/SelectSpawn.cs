    ...
    public class ShipStatisPrespawnStepPatch
    {
        ...
        static SpawnInMinigame.SpawnLocation Create(SpawnInMinigame miniGame, Tuple<StringNames, Vector3, string, Func<AudioClip>> obj)
        {
            ...
            return new()
            {
                Name = obj.Item1,
                Location = obj.Item2,
                Image = AssetManager.GetAsset<Sprite>($"FungleSelectSpawn.{obj.Item3}.png"),
                Rollover = null,
        ...
        public static IEnumerator SelectSpawn()
        {
            ...
            SpawnInMinigame spawnInMinigame = GameObject.Instantiate<SpawnInMinigame>(airship.TryCast<AirshipStatus>().SpawnInGame);
