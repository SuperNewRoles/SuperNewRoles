...
namespace SuperNewRoles.Patch
{
    ...
    public class AdminPatch
    {
        ...
        static void UseAdminTime()
        {
            ...
            {
                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(CachedPlayer.LocalPlayer.NetId, (byte)CustomRPC.CustomRPC.UseAdminTime, Hazel.SendOption.None, -1);
