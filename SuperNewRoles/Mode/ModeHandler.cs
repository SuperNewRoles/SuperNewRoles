...
public static class ModeHandler
{
    ...
    public static bool IsMode(ModeId mode, bool IsChache = true)
    {
        ...
        if (AmongUsClient.Instance is not null && AmongUsClient.Instance.NetworkMode == NetworkModes.FreePlay || !PlayerControlHelper.IsMod(AmongUsClient.Instance.HostId))
