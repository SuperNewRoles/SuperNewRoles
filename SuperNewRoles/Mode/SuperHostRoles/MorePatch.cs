...
namespace SuperNewRoles.Mode.SuperHostRoles
{
    class MorePatch
    {
                ...
                byte amount)
        {
            ...
            {
                if ((player.isRole(RoleId.Jackal) && !RoleClass.Jackal.IsUseSabo) || player.isRole(RoleId.RemoteSheriff) || player.isRole(RoleId.Sheriff) || player.isRole(RoleId.truelover) || player.isRole(RoleId.FalseCharges)) return false;
