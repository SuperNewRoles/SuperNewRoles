        ...
        public static void CustomSyncSettings(this PlayerControl player)
        {
            ...
            switch (role)
            {
                ...
                case RoleId.truelover:
                    optdata.ImpostorLightMod = optdata.CrewLightMod;
                    var switchSystemtruelover = MapUtilities.CachedShipStatus.Systems[SystemTypes.Electrical].Cast<SwitchSystem>();
                ...
                case RoleId.FalseCharges:
                    optdata.ImpostorLightMod = optdata.CrewLightMod;
                    var switchSystemFalseCharges = MapUtilities.CachedShipStatus.Systems[SystemTypes.Electrical].Cast<SwitchSystem>();
                ...
                case RoleId.RemoteSheriff:
                    optdata.ImpostorLightMod = optdata.CrewLightMod;
                    var switchSystemRemoteSheriff = MapUtilities.CachedShipStatus.Systems[SystemTypes.Electrical].Cast<SwitchSystem>();
                ...
                case RoleId.Arsonist:
                    optdata.ImpostorLightMod = optdata.CrewLightMod;
                    var switchSystemArsonist = MapUtilities.CachedShipStatus.Systems[SystemTypes.Electrical].Cast<SwitchSystem>();
                ...
                case RoleId.Nocturnality:
                    var switchSystemNocturnality = MapUtilities.CachedShipStatus.Systems[SystemTypes.Electrical].Cast<SwitchSystem>();
                ...
                case RoleId.Jackal:
                    ...
                    {
                        optdata.ImpostorLightMod = optdata.CrewLightMod;
                        var switchSystemJackal = MapUtilities.CachedShipStatus.Systems[SystemTypes.Electrical].Cast<SwitchSystem>();
