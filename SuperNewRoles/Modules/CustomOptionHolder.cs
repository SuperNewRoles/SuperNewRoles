...
namespace SuperNewRoles.Modules
{
    public class CustomOptionHolder
    {
        ...
        public static void Load()
        {
            ...
            VampireDependentsKillCoolTime = Create(1076, false, CustomOptionType.Impostor, "VampireCreateDependentsCoolTime", 30f, 2.5f, 120f, 2.5f, VampireCanCreateDependents);
            VampireDependentsCanVent = Create(1076, false, CustomOptionType.Impostor, "VampireCreateDependentsCoolTime", 30f, 2.5f, 120f, 2.5f, VampireCanCreateDependents);
