...
namespace SuperNewRoles.Modules
{
    ...
    public class CustomRoleOption : CustomOption
    {
        ...
        public CustomRoleOption(int id, bool isSHROn, CustomOptionType type, string name, Color color, int max = 15) :
            base(id, isSHROn, type, ModHelpers.ColorString(color, name), CustomOptionHolder.rates, "", null, true, false, "")
        {
            try
            {
    ...
    class GameOptionsDataPatch
    {
        ...
        public static string ResultData()
        {
            ...
            var optionName = ModHelpers.ColorString(new Color(204f / 255f, 204f / 255f, 0, 1f), Tl("SettingCrewmateRoles"));
            ...
            optionName = ModHelpers.ColorString(new Color(204f / 255f, 204f / 255f, 0, 1f), Tl("SettingCrewmateGhostRoles"));
            ...
            optionName = ModHelpers.ColorString(new Color(204f / 255f, 204f / 255f, 0, 1f), Tl("SettingNeutralRoles"));
            ...
            optionName = ModHelpers.ColorString(new Color(204f / 255f, 204f / 255f, 0, 1f), Tl("SettingNeutralGhostRoles"));
            ...
            optionName = ModHelpers.ColorString(new Color(204f / 255f, 204f / 255f, 0, 1f), Tl("SettingImpostorRoles"));
            ...
            optionName = ModHelpers.ColorString(new Color(204f / 255f, 204f / 255f, 0, 1f), Tl("SettingImpostorGhostRoles"));
