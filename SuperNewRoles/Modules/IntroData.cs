...
public class IntroData
{
    ...
    public static IntroData MadRaccoonIntro = new("MadRaccoon", MadRaccoon.RoleClass.color, 1, RoleId.MadRaccoon, teamType: TeamType.Impostor, IntroSound: RoleTypes.Impostor);
    // イントロオブジェ
}