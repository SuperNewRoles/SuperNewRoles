...
public class IntroData
{
    ...
    public static IntroData WorshiperIntro = new("Worshiper", Worshiper.RoleClass.color, 1, RoleId.Worshiper, teamType: TeamType.Impostor, IntroSound: RoleTypes.Impostor);
