...
public class IntroData
{
    ...
    public static IntroData MadRaccoonIntro = new("MadRaccoon", MadRaccoon.RoleClass.color, 2, RoleId.MadRaccoon, teamType: TeamType.Impostor, IntroSound: RoleTypes.Impostor);
    // イントロオブジェ
}