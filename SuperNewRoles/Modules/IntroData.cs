...
namespace SuperNewRoles.Modules
{
    ...
    public class IntroData
    {
        ...
        public static IntroData NiceGuesserIntro = new("NiceGuesser", RoleClass.NiceGuesser.color, 1, RoleId.NiceGuesser, TeamRoleType.Crewmate);
        ...
        public static IntroData KnightIntro = new("Knight", Roles.Crewmate.Knight.color, 1, RoleId.Knight, TeamRoleType.Crewmate);
        ...
        public static IntroData HamburgerShopIntro = new("HamburgerShop", RoleClass.HamburgerShop.color, 3, RoleId.HamburgerShop, TeamRoleType.Crewmate);
        //イントロオブジェ
    }
}