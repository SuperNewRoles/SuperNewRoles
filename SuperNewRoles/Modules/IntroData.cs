...
public class IntroData
{
    ...
    public static IntroData PoliceSurgeonIntro = new("PoliceSurgeon", RoleClass.PoliceSurgeon.color, 1, RoleId.PoliceSurgeon, TeamRoleType.Crewmate, IntroSound : RoleTypes.Scientist);
    // イントロオブジェ
}