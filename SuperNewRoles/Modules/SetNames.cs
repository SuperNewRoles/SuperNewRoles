...
namespace SuperNewRoles.Modules
{
    public class SetNamesClass
    {
        ...
        public static void LoversSet()
        {
            ...
            else if (CachedPlayer.LocalPlayer.PlayerControl.IsRole(RoleId.Cupid) && RoleClass.Cupid.Created && RoleClass.Cupid.currentLovers != null)
            {
            ...
            else if ((CachedPlayer.LocalPlayer.PlayerControl.IsDead() || CachedPlayer.LocalPlayer.PlayerControl.IsRole(RoleId.God)) && RoleClass.Lovers.LoversPlayer != new List<List<PlayerControl>>())
            {
