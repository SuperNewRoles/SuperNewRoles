...
namespace SuperNewRoles.Patch
{
    ...
    public class CameraPatch
    {
        ...
        static void UseCameraTime()
        {
            ...
            {
                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(CachedPlayer.LocalPlayer.NetId, (byte)CustomRPC.UseCameraTime, SendOption.Reliable, -1);
        ...
        class SurveillanceMinigamePatch
        {
            ...
            {
                public static void Prefix() => cameraTimer = 0f;
            ...
            {
                static void Prefix() => UseCameraTime();
            }
        }
