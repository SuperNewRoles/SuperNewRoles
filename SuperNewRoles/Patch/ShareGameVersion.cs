        ...
        public class AmongUsClientOnPlayerJoinedPatch
        {
            public static void Postfix()
            {
                if (PlayerControl.LocalPlayer != null)
                {
                    ...
                    MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.CustomRPC.ShareSNRVersion, Hazel.SendOption.None, -1);
        ...
        public class GameStartManagerUpdatePatch
        {
            ...
            public static void Postfix(GameStartManager __instance)
            {
                ...
                if (AmongUsClient.Instance.AmHost)
                {
                    ...
                    if (RPCTimer <= 0)
                    {
                        MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.CustomRPC.SetRoomTimerRPC, Hazel.SendOption.None, -1);
                ...
                else
                {
                    ...
                    if (minutes == 0 && seconds < 5 && !notcreateroom && ConfigRoles.IsAutoRoomCreate.Value) {
                        //MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.CustomRPC.AutoCreateRoom, Hazel.SendOption.None, -1);
                        //AmongUsClient.Instance.FinishRpcImmediately(writer);
