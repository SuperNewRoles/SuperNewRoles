...
class BanBlockedPlayerPatch
{
    ...
    {
        SuperNewRolesPlugin.Logger.LogInfo($"{client.PlayerName}(ClientID:{client.Id})(PUID:{client.ProductUserId})(HashedPUID:{Blacklist.BlacklistHash.ToHash(client.ProductUserId)})が参加");
