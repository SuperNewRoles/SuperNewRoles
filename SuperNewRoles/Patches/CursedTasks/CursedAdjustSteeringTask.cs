...
public class CursedAdjustSteeringTask
{
    ...
    public static class NavigationMinigamePatch
    {
        ...
        public static void BeginPostfix(NavigationMinigame __instance)
        {
            ...
            var radar = AssetManager.GetAsset<Sprite>("Radar.png");
            if (radar) __instance.transform.Find("Background").GetComponent<SpriteRenderer>().sprite = radar;
            Target = Object.Instantiate(__instance.transform.Find("Border").gameObject, __instance.transform);
            Target.name = "Target";
            var targetSprite = AssetManager.GetAsset<Sprite>("Target.png");
            if (targetSprite) Target.GetComponent<SpriteRenderer>().sprite = targetSprite;
