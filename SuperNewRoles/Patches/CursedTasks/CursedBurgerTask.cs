...
public class CursedBurgerTask
{
    ...
    public static class BurgerMinigamePatch
    {
        ...
        public static void BeginPostfix(BurgerMinigame __instance)
        {
            ...
            switch (ModHelpers.GetRandomFloat(1f))
            {
                case <= 0.50f: // 50%
                    ...
                    {
                        BurgerToppingTypes topping = (BurgerToppingTypes)UnityEngine.Random.Range(0, 6);
                ...
                case <= 0.70f: // 20%
                    __instance.ExpectedToppings = new(6);
                    __instance.ExpectedToppings[0] = BurgerToppingTypes.Plate;
                    BurgerToppingTypes bun = (new BurgerToppingTypes[] { BurgerToppingTypes.Meat, BurgerToppingTypes.Onion, BurgerToppingTypes.Tomato }).ToList().GetRandom();
                    __instance.ExpectedToppings[1] = bun;
                    __instance.ExpectedToppings[5] = bun;
                    for (int i = 2; i < __instance.ExpectedToppings.Count - 1; i++)
                    {
                        BurgerToppingTypes topping = (BurgerToppingTypes)UnityEngine.Random.Range(2, 6);
                        bool set = __instance.ExpectedToppings.Count(t => t == topping) < topping switch
                        {
                            BurgerToppingTypes.TopBun => 1,
                            BurgerToppingTypes.BottomBun => 1,
                ...
                case <= 0.90f: // 20%
                    ...
                    for (int i = 2; i < __instance.ExpectedToppings.Count - 1; i++)
                    {
                        BurgerToppingTypes topping = (new BurgerToppingTypes[] { BurgerToppingTypes.Lettuce, BurgerToppingTypes.Onion, BurgerToppingTypes.Tomato }).ToList().GetRandom();
                        bool set = __instance.ExpectedToppings.Count(t => t == topping) < topping switch
                        {
                            BurgerToppingTypes.TopBun => 1,
                            BurgerToppingTypes.BottomBun => 1,
                ...
                case <= 1.00f: // 5%
                    __instance.ExpectedToppings = new(6);
                    __instance.ExpectedToppings[0] = BurgerToppingTypes.Plate;
                    if (ModHelpers.GetRandomFloat(1f) < 0.1f)
                    {
                        __instance.ExpectedToppings[1] = BurgerToppingTypes.Lettuce;
                        __instance.ExpectedToppings[5] = BurgerToppingTypes.Lettuce;
                    }
                    ...
                    if (ModHelpers.GetRandomFloat(1f) < 0.01f)
                    {
