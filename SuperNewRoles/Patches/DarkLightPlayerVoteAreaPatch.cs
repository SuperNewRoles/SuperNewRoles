...
{
    public static readonly Color DarkLightColor = new(0.4f, 0.4f, 0.4f, 1f);
    ...
    public static void Postfix(PlayerVoteArea __instance, NetworkedPlayerInfo playerInfo)
    {
        ...
        if (darkLight != null)
        {
            darkLight.color = CustomColors.LighterColors.Contains(playerInfo.DefaultOutfit.ColorId) ? LightColor : DarkLightColor;
            return;
        }
