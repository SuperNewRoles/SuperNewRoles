    ...
    class FreeNamePatch
    {
        public static void Initialize()
        {
            SceneManager.add_sceneLoaded((Action<Scene, LoadSceneMode>)((scene, _) =>
            {
                ...
                EditName editName = AccountManager.Instance.accountTab.editNameScreen;
                GameObject NameText = Object.Instantiate(editName.nameText.gameObject);
                NameText.transform.localPosition += Vector3.up * 2.2f;
                TextBoxTMP textBox = NameText.GetComponent<TextBoxTMP>();
        ...
        private static bool TryMoveObjects()
        {
            ...
            Vector3 yStart = Vector3.up;
            Vector3 yOffset = Vector3.down * 1.5f;
            List<GameObject> gameObjects = toMove.Select(x => GameObject.Find("NormalMenu/" + x)).ToList();
