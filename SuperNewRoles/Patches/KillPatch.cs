...
class KillButtonDoClickPatch
{
    public static bool Prefix(KillButton __instance)
    {
        ...
        if (!(__instance.currentTarget.IsRole(RoleId.Bait) || __instance.currentTarget.IsRole(RoleId.OldNiceRedRidingHood)) && PlayerControl.LocalPlayer.IsRole(RoleId.Vampire))
        {
