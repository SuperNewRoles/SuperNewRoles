        ...
        public class BaitUpdate
        {
            public static void Postfix(PlayerControl __instance)
            {
                ...
                if (deadPlayer.killerIfExisting != null && RoleClass.Bait.ReportTime <= 0f)
                {
                    ...
                    {
                        MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(CachedPlayer.LocalPlayer.NetId, (byte)CustomRPC.CustomRPC.ReportDeadBody, Hazel.SendOption.None, -1);
