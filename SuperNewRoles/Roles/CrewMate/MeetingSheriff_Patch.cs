...
class MeetingSheriff_Patch
{
    static void MeetingSheriffOnClick(int Index, MeetingHud __instance)
    {
        ...
        FinalStatusClass.RpcSetFinalStatus(misfire ? CachedPlayer.LocalPlayer : Target, misfire ? FinalStatus.MeetingSheriffMisFire : (Target.IsHauntedWolf() ? FinalStatus.MeetingSheriffHauntedWolfKill : FinalStatus.MeetingSheriffKill));
