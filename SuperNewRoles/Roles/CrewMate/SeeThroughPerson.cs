...
namespace SuperNewRoles.Roles.CrewMate
{
    public static class SeeThroughPerson
    {
        ...
        public static void FixedUpdate()
        {
            foreach (PlainDoor door in ShipStatus.Instance.AllDoors)
            {
                EdgeCollider2D obj = RoleClass.SeeThroughPerson.Objects.Find(data => data.name == "Door-SeeThroughPersonCollider-" + door.transform.position.x + "." + door.transform.position.y + "." + door.Id);
