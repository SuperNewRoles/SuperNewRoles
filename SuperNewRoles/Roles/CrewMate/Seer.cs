...
class Seer : RoleBase<Seer>
{
    ...
    public override List<Func<AbilityBase>> Abilities { get; } = [() => new SeerAbility(new SeerData() { Mode = Mode, LimitSoulDuration = LimitSoulDuration, SoulDuration = SoulDuration, ColorMode = SeerColorMode.None })];
