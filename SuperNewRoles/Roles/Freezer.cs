...
namespace SuperNewRoles.Roles
{
    public class Freezer
    {
        ...
        {
            MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(CachedPlayer.LocalPlayer.NetId, (byte)CustomRPC.CustomRPC.SetSpeedFreeze, SendOption.None, -1);
            writer.Write(true);
