...
namespace SuperNewRoles.Roles.Impostor
{
    ...
    public class CrabAbility : CustomButtonBase, IButtonEffect
    {
        ...
        Action IButtonEffect.OnEffectEnds => () => { RpcSetCrab(this, false); };
        ...
        public override void OnClick() { RpcSetCrab(this, true); }

        [CustomRPC]
        public static void RpcSetCrab(CrabAbility ability, bool isCrabActive)
        {
            ability.IsCrabActive = isCrabActive;
        }
