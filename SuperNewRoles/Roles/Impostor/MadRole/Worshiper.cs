...
public static class Worshiper
{
    internal class CustomOptionData
    {
        ...
        public static void SetupCustomOptions()
        {
            ...
            var taskOption = SelectTask.TaskSetting(optionId, optionId + 1, optionId + 2, IsCheckImpostor, CustomOptionType.Crewmate, true); optionId += 3;
            ...
            ParcentageForTaskTriggerSetting = Create(optionId, false, CustomOptionType.Crewmate, "ParcentageForTaskTriggerSetting", rates4, IsParcentageForTaskTrigger, roleId: RoleId.Worshiper);
        }
    }
