...
namespace SuperNewRoles.Roles
{
    public class Speeder
    {
        ...
        {
            MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(CachedPlayer.LocalPlayer.PlayerControl.NetId, (byte)CustomRPC.SetSpeedDown, SendOption.Reliable, -1);
            writer.Write(true);
