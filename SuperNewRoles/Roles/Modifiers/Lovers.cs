...
class Lovers : ModifierBase<Lovers>
{
    ...
    public override List<Func<AbilityBase>> Abilities => [() => new LoversAbility(LoversKnowPartnerRole, LoversKnowPartnerPosition), () => new CustomTaskAbility(() => (null, false, null), null)];
