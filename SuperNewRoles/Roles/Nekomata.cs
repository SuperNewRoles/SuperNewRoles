...
namespace SuperNewRoles.Roles
{
    class Nekomata
    {
        ...
        public static void NekomataProc(List<PlayerControl> p)
        {
            ...
            {
                MessageWriter RPCWriter = AmongUsClient.Instance.StartRpcImmediately(CachedPlayer.LocalPlayer.NetId, (byte)CustomRPC.CustomRPC.NekomataExiledRPC, Hazel.SendOption.None, -1);
