...
namespace SuperNewRoles.Roles
{
    class PositionSwapper
    {
        ...
        public static void SwapStart(){
            ...
            MessageWriter Writer = AmongUsClient.Instance.StartRpcImmediately(CachedPlayer.LocalPlayer.NetId, (byte)CustomRPC.CustomRPC.PositionSwapperTP, Hazel.SendOption.None, -1);
