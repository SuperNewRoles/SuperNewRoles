    ...
    public static class RoleHelpers
    {
        ...
        public static void SetRole(this PlayerControl player, RoleId role)
        {
            switch (role)
            {
                ...
                case RoleId.SuperVitaler:
                    RoleClass.SuperVitaler.SuperVitalerPlayer.Add(player);
                    break;
        ...
        public static RoleId GetRole(this PlayerControl player, bool IsChache = true)
        {
            ...
            try
            {
                ...
                else if (RoleClass.SuperVitaler.SuperVitalerPlayer.IsCheckListPlayerControl(player)) return RoleId.SuperVitaler;
