...
public class OptionInfo
{
    ...
    private (float AbilityCountDefault, float AbilityCountMin, float AbilityCountMax, float AbilityCountStep, bool SupportSHR)? AbilityCountOpt { get; }
    ...
    public OptionInfo(RoleId role, int OptionId, bool SupportSHR,
        ...
        (float AbilityCountDefault, float AbilityCountMin, float AbilityCountMax, float AbilityCountStep, bool SupportSHR)? AbilityCountOption = null,
