...
namespace SuperNewRoles.Roles
{
    public class Shielder
    {
        ...
        public class HudManagerUpdatePatch
        {
            ...
            {
                if (HudManagerStartPatch.ShielderButton.Timer <= 0.1f && RoleClass.Shielder.IsShield[PlayerControl.LocalPlayer.PlayerId] && PlayerControl.LocalPlayer.isRole(RoleId.Shielder))
                {
                    ...
                    RPCProcedure.SetShielder(PlayerControl.LocalPlayer.PlayerId, false);
